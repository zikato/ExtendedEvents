    ...
    (
        ...
        (
            ...
            (
                ...
                -- OR [sqlserver].[like_i_sql_unicode_string]([object_name], N'sp_%clean%') /* too many calls to cdc or MSDB cleanups */
                ...
                OR
                (
                    [sqlserver].[equal_i_sql_unicode_string]([object_name], N'sp_configure') /* Server options */
                    and statement <> N'Exec sp_configure  ''external scripts enabled'''
                )
